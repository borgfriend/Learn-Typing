...
it("renders ok green", () => {
	const { container } = render(
		<ExerciseChar data={{ color: "ok", value: "a" }} isCurrent={false} />,
	);
...
it("renders error red", () => {
	const { container } = render(
		<ExerciseChar data={{ color: "error", value: "a" }} isCurrent={false} />,
	);
...
it("renders current yellow", () => {
	const { container } = render(
		<ExerciseChar data={{ color: "ok", value: "a" }} isCurrent={true} />,
	);
